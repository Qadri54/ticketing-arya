...
<head>
    ...
    <title>Tambah Event Baru - TICKS ID</title>
...
<body class="bg-canvas-soft text-ink font-sans antialiased min-h-screen flex flex-col">
    ...
    <header class="h-20 bg-brand-dark border-b border-white/10 flex items-center justify-between px-8 sticky top-0 z-50 shadow-level-1">
        ...
        <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full border border-white/10">
            ...
            <span class="text-[11px] font-bold text-white tracking-wide uppercase">Katalog</span>
        </div>
    </header>
    ...
    <div class="bg-gradient-to-r from-brand-dark via-primary-deep to-primary text-white py-12 px-8 shadow-inner">
        <div class="max-w-6xl w-full mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <span class="text-primary-subdued font-bold text-xs uppercase tracking-widest bg-white/10 px-3 py-1 rounded-full border border-white/10">Penerbitan Panel</span>
                <h1 class="text-[36px] font-bold tracking-tight font-syne mt-2">Buat Event Baru</h1>
                <p class="text-[14px] text-white/70 font-light mt-1">Lengkapi formulir pendaftaran untuk merilis data penjualan tiket ke publik.</p>
            </div>
            <div class="text-right hidden md:block">
                <span class="text-[28px] opacity-20 font-syne font-black tracking-wider">TICKS ID PRODUCTIONS</span>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white border border-hairline rounded-[24px] shadow-level-1 p-8 space-y-6 relative overflow-hidden">
                        ...
                        <h2 class="text-[18px] font-bold text-brand-dark border-b border-hairline pb-3 flex items-center gap-2">
                            <i class="bi bi-file-earmark-medical text-primary"></i> Parameter Informasi Acara
                        </h2>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: Medan Jazz Festival 2026"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="category" id="category-select" required class="w-full bg-canvas-soft focus:bg-white border border-hairline text-ink text-[15px] font-medium rounded-xl pl-11 pr-4 py-3.5 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200 appearance-none cursor-pointer">
                                        ...
                                        <option value="CULINARY FEST">CULINARY FEST</option>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="location" value="{{ old('location') }}" required placeholder="Contoh: Lapangan Benteng, Medan"
                        ...
                        <div id="online-options" class="hidden space-y-6 mt-6 pt-6 border-t border-hairline transition-all duration-500">
                            <div class="p-5 border-2 border-dashed border-ruby/30 rounded-xl bg-ruby/5">
                                ...
                                <p class="text-[11px] text-ruby/80 font-medium mb-3">Isi jika event ini menyiarkan tayangan langsung. Link akan dikunci oleh sistem dan hanya muncul setelah pelanggan lunas membayar tiket kategori Online.</p>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-ruby/60"><i class="bi bi-link-45deg text-lg"></i></span>
                                    <input type="url" name="youtube_link" value="{{ old('youtube_link') }}" placeholder="Contoh: https://www.youtube.com/watch?v=..."
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5" required placeholder="Tuliskan detail rundown jadwal, daftar pengisi acara (guest star), aturan hak masuk, dan info penting penonton lainnya..."
                                class="w-full bg-canvas-soft focus:bg-white border border-hairline text-ink text-[15px] rounded-xl px-4 py-3.5 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-hairline rounded-[24px] shadow-level-1 p-6 space-y-5 relative overflow-hidden">
                        ...
                        <h2 class="text-[18px] font-bold text-brand-dark border-b border-hairline pb-3 flex items-center gap-2">
                            <i class="bi bi-sliders text-primary"></i> Logistik & Distribusi
                        </h2>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="datetime-local" name="event_date" value="{{ old('event_date') }}" required
                                    class="w-full bg-canvas-soft focus:bg-white border border-hairline text-ink text-[14px] font-semibold rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div id="online-price-wrapper" class="hidden">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="online_price" value="{{ old('online_price', 0) }}" min="0"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="quota" value="{{ old('quota') }}" required min="1" placeholder="Contoh: 500"
                    ...
                    <div class="bg-gradient-to-b from-white to-primary/5 border border-hairline rounded-[24px] shadow-level-1 p-6 space-y-4">
                        ...
                        <div class="relative group aspect-video w-full rounded-xl bg-canvas-soft border-2 border-dashed border-primary/20 overflow-hidden flex items-center justify-center shadow-inner">
                            <div class="text-center p-4 transition-opacity duration-200" id="placeholder-box">
                                <i class="bi bi-cloud-arrow-up-fill text-[36px] text-primary/60 block mb-1 animate-bounce"></i>
                                <span class="text-primary text-[13px] font-bold block">Unggah Selebaran</span>
                                <span class="text-ink-mute text-[10px] block mt-0.5">Sistem Seret atau Klik Telusuri</span>
                            </div>
                            <img id="poster-preview" class="w-full h-full object-cover hidden transition-transform duration-300 group-hover:scale-105">
                            <div id="hover-overlay" class="absolute inset-0 bg-brand-dark/60 opacity-0 group-hover:opacity-100 transition-opacity hidden items-center justify-center backdrop-blur-xs">
                                <span class="text-white text-xs font-semibold bg-primary px-4 py-2 rounded-full shadow-lg"><i class="bi bi-arrow-repeat mr-1"></i> Ganti File Poster</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-ink-mute mt-2">Format yang didukung: JPG, PNG (Max 2MB).</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 bg-brand-dark border border-white/10 rounded-[24px] p-6 shadow-level-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span class="text-[13px] text-white/70 font-medium flex items-center gap-1.5">
                    <i class="bi bi-info-circle-fill text-primary-subdued"></i> Tiket yang diterbitkan akan langsung terdistribusi.
                </span>
                <div class="flex items-center gap-4 w-full sm:w-auto shrink-0">
                    <a href="{{ route('admin.events.index') }}" class="text-[14px] text-white/70 hover:text-white font-bold px-5 py-3 transition-colors rounded-full hover:bg-white/5 w-center text-center w-full sm:w-auto">Batal</a>
                    <button type="submit" class="bg-primary hover:bg-primary-press text-white px-8 py-3.5 rounded-full text-[14px] font-bold transition-all shadow-md hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 w-full sm:w-auto text-center flex items-center justify-center gap-2">
                        <i class="bi bi-rocket-takeoff-fill"></i> Simpan & Publikasikan
                    </button>
                </div>
            </div>
        </form>
